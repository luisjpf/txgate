//! Comprehensive integration tests for txgate-crypto to achieve 100% coverage.
//!
...
use txgate_core::error::{SignError, StoreError};
use txgate_crypto::{
...
fn test_public_key_clone() {
    use txgate_crypto::keypair::Secp256k1PublicKey;
