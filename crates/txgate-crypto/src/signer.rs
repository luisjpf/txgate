...
///
/// ```rust
/// use txgate_crypto::signer::{Signer, Secp256k1Signer, Chain, CurveType};
///
...
pub trait Signer: Send + Sync {
    ...
    ///
    /// ```rust
    /// use txgate_crypto::signer::{Signer, Secp256k1Signer};
    /// use sha3::{Digest, Keccak256};
    ///
    /// let signer = Secp256k1Signer::generate();
    ///
    ...
    ///
    /// ```rust
    /// use txgate_crypto::signer::{Signer, Secp256k1Signer, CurveType};
    ///
    /// let signer = Secp256k1Signer::generate();
    /// assert_eq!(signer.curve(), CurveType::Secp256k1);
    /// ```
