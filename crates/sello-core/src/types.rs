//! Core types for the Sello signing service.
//!
//! This module provides the foundational types used across all Sello crates:
//!
...
//!
//! ```
//! use sello_core::types::{ParsedTx, TxType, PolicyResult};
...
///
/// ```
/// use sello_core::types::PolicyResult;
///
