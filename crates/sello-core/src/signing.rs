//! Signing flow orchestration for the Sello signing service.
//!
...
//!
//! ```ignore
//! use sello_core::signing::{SigningService, SigningResult};
//! use sello_chain::Chain;
//! use sello_policy::PolicyEngine;
//! use sello_crypto::Signer;
//!
...
///
/// ```ignore
/// use sello_core::signing::SigningService;
///
...
/// It mirrors the `Chain` trait from `sello-chain`.
...
///
/// This trait is defined here to avoid circular dependencies.
/// It mirrors the `PolicyEngine` trait from `sello-policy`.
...
///
/// This trait is defined here to avoid circular dependencies.
/// It mirrors the `Signer` trait from `sello-crypto`.
