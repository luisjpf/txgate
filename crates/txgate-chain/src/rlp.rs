...
//! Ethereum transaction decoding and improve error handling with `TxGate`'s
//! error types.
//!
//! # Overview
//!
...
//!
//! ```
//! use txgate_chain::rlp::{detect_tx_type, is_list, typed_tx_payload};
//!
...
///
/// ```
/// use txgate_chain::rlp::detect_tx_type;
///
...
///
/// ```
/// use txgate_chain::rlp::typed_tx_payload;
///
/// // EIP-1559 transaction
/// let typed = [0x02, 0xf8, 0x73, 0x01];
...
///
/// ```
/// use txgate_chain::rlp::decode_list;
///
/// // Empty list (0xc0)
/// let empty_list = [0xc0];
...
///
/// ```
/// use txgate_chain::rlp::decode_u256;
...
///
/// ```
/// use txgate_chain::rlp::decode_address;
///
...
///
/// ```
/// use txgate_chain::rlp::decode_optional_address;
///
...
///
/// ```
/// use txgate_chain::rlp::decode_u64;
///
/// // Zero
/// let zero = [0x80];
