...
//!
//! Implementation of the `sello solana address` command that displays
//! the Solana address derived from the default ed25519 signing key.
//!
//! ## Usage
//!
//! ```no_run
//! use sello::cli::commands::solana::AddressCommand;
//!
...
use sello_crypto::signer::{Chain, Ed25519Signer, Signer};
...
/// The `sello solana address` command handler.
///
